...
public class BillManagementFragment extends Fragment {
    ...
    private BillManagementViewModel billManagementViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
      ...
      //  billManagementViewModel =
        ...
        final TextView textView = root.findViewById(R.id.text_bill_management);
        billManagementViewModel.getText().observe(this, new Observer<String>() {
            @Override
